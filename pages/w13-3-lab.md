...
![FedAvg 수렴(예시) — 통신 라운드가 진행될수록 글로벌 손실이 감소한다. 데이터를 모으지 않고도 학습이 되며, Non-IID(편향 분포)면 더 느리고 불안정하게 수렴한다](../assets/w13_p3_fedavg_sim_06.png)
...
4. **학기말 프로젝트 마무리** — 14주차 논문 세미나 순서를 정비하고, 15주차 최종 캡스톤 결과물(정확도·지연 개선·프로파일링)의 배포 검증을 준비한다.
...
- 다음은 14주차 최신 연구 동향·학술 세미나로, 한 학기 기술을 학문적으로 종합한다.
