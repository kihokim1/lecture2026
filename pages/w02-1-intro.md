...
이 배분의 성패는 단순히 각 유닛의 속도가 아니라, **유닛 사이에서 데이터를 얼마나 적게 옮기느냐**에 달려 있다(1.1의 Memory Wall과 직결). 이 관점은 3주차의 추론 엔진(연산을 어느 유닛에 위임할지 결정하는 Delegate)과 11주차의 하드웨어 가속기 프로그래밍으로 이어진다.
