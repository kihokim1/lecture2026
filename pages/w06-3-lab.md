...
## 3.3 과제 및 7주차 중간 프로젝트 점검 (10분 안내)
...
3. **중간 프로젝트 제안서 검토** — 지금까지 배운 경량화 기법(Pruning·Quantization·KD) 중 **최소 2개를 조합**한 최적화 전략을 구상해 한 페이지로 정리한다. (7주차 중간고사 범위: 1~6주차)
