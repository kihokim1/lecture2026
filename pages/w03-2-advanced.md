...
- **TVM (Apache TVM)** — 앞의 둘이 **인터프리터** 계열이라면, TVM은 **AI 컴파일러** 접근이다. 모델 그래프를 타깃 백엔드(ARM, RISC-V, CUDA 등)에 맞는 기계어로 **미리 컴파일**해 최적화한다. 이식성과 백엔드별 자동 튜닝이 강점이며, 이 컴파일러 관점은 11주차 하드웨어 가속기 프로그래밍에서 다시 심화된다.
