...
## 그림 목록
- `w09_p1_tinyml_spectrum_01.png` — 컴퓨팅 스펙트럼(Cloud→MCU)과 자원 규모
- `w09_p1_mcu_constraints_02.png` — MCU의 자원 제약
- `w09_p1_sw_stack_03.png` — TinyML 소프트웨어 스택
- `w09_p2_duty_cycling_04.png` — Duty Cycling 전력 프로파일
- `w09_p2_depthwise_05.png` — 표준 Conv vs Depthwise Separable Conv
- `w09_p3_deploy_06.png` — MCU 배포 파이프라인과 Peak Memory

## 선수 연결
- 2주차의 저전력 MCU(Cortex-M)와 Memory Wall이 극단으로 나타나는 환경.
- 5주차 양자화(정수 INT8)가 TinyML의 사실상 필수 전제.
- 8주차 중간고사 이후, 후반부(응용) 첫 주차.
